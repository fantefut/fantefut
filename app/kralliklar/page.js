...
export default function KralliklarSayfasi() {
  ...
  <div style={{ display: 'flex', gap: '6px', justifyContent: 'center', flexWrap: 'wrap', marginBottom: '6px' }}>
    <Link href="/kralliklar" style={{ padding: '6px 12px', borderRadius: '6px', border: '1px solid #3b82f6', backgroundColor: '#3b82f6', color: '#fff', fontSize: '0.875rem', fontWeight: '600', textDecoration: 'none' }}>Gol & Asist</Link>
  ...
  return (
    <div style={{ padding: '10px', backgroundColor: '#ffffff', minHeight: '100vh', fontFamily: ICERIK_FONTU }}>
      ...
      <div style={{ maxWidth: '900px', margin: '0 auto', fontFamily: ICERIK_FONTU }}>
        ...
        {/* Ortak 4-3-2 Düzenindeki Yeni Navbar Bileşeni (Gol & Asist aktif) */}
