...
export default function KralliklarSayfasi() {
  ...
  return (
    <div style={{ padding: '10px', backgroundColor: '#ffffff', minHeight: '100vh', fontFamily: ICERIK_FONTU }}>
      ...
      {/* 🚀 KUSURSUZ EŞİTLENMİŞ VE RESPONSIVE HEADER ALANI */}
      <div className="site-header" style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', textAlign: 'center', padding: '15px 0 5px 0' }}>
        
        {/* LOGO ARTIK TIKLANABİLİR VE ENTEGRE HALE GELDİ */}
        <Link href="/" style={{ display: 'inline-block', textDecoration: 'none' }}>
          <img 
            src="/logo.png" 
            alt="FanteFut Logo" 
            className="header-logo"
            style={{ width: '80px', height: '80px', marginBottom: '5px', objectFit: 'contain' }} 
          />
        </Link>

        {/* FANTEFUT BAŞLIĞI */}
        <Link href="/" style={{ textDecoration: 'none' }}>
          <h1 className="brand-name" style={{ fontSize: '3rem', fontWeight: 'bold', fontStyle: 'italic', color: '#132444', fontFamily: BAŞLIK_FONTU, margin: '0', letterSpacing: '1px' }}>
            FanteFut
          </h1>
        </Link>

        {/* ALT SAYFA BAŞLIĞI */}
        <h2 className="sub-header" style={{ fontSize: '1.2rem', fontWeight: 'bold', color: '#1e293b', fontFamily: '"Palatino Linotype", "Book Antiqua", Palatino, serif', margin: '4px 0 0 0' }}>
          Süper Lig Gol ve Asist Krallığı
        </h2>
      </div>
