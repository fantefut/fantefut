    ...
    <div style={{ padding: '10px', backgroundColor: '#ffffff', minHeight: '100vh', fontFamily: ICERIK_FONTU }}>
      ...
      <div style={{ maxWidth: '900px', margin: '0 auto', fontFamily: ICERIK_FONTU }}>
        <div style={{ borderBottom: '1px solid #f1f5f9', paddingBottom: '12px', marginBottom: '25px', display: 'flex', gap: '6px', justifyContent: 'center', flexWrap: 'wrap' }}>
          ...
          <Link href="/haftanin-analizi" style={getBtn('analiz', true)}>Analiz</Link>
        </div>
        ...
        <div style={{ maxWidth: '400px', margin: '0 auto' }}>
          ...
          <div style={{ backgroundColor: '#f8fafc', border: '1px solid #cbd5e1', borderRadius: '8px', padding: '15px', color: '#1e293b', fontSize: '14px', fontWeight: '500', lineHeight: '1.6', marginBottom: '25px' }}>
            ...
            <p style={{ margin: '0' }}>İlk 11 de başlayacak oyuncuları bulmak, oyunda yüksek puan kazanmak için çok kritik. Bu yüzden Avrupa'da maç yapan takımlarımızın rotasyonunu dikkatli takip etmek gerekir.</p>
          </div>
